...
# /root/GCTA/gcta64 --reml --mgrm ../input/GCTA/multi_GRMs.txt --mpheno 1 \
# --pheno ../input/GCTA/pheno_gcta.txt \
# --out ../input/GCTA/$prefix.severe \
# --qcovar ../input/GCTA/age.qcovar  \
# --covar ../input/GCTA/sex.covar \
# --thread-num 100 --reml-no-constrain --reml-maxit 1000
# 
# /root/GCTA/gcta64 --reml --mgrm ../input/GCTA/multi_GRMs.txt --mpheno 2 \
# --pheno ../input/GCTA/pheno_gcta.txt \
# --out ../input/GCTA/$prefix.resist \
# --qcovar ../input/GCTA/age.qcovar \
# --covar ../input/GCTA/sex.covar \
# --thread-num 100 --reml-no-constrain --reml-maxit 1000
